...
`;
      ...
      <div id="cssscan-license-modal-content">
        ...
        <div id="cssscan-license-modal-step-1">
          ...
          <input type="text" id="cssscan-license-input" value="NULLED-BY-JUSTHMMMM-YAM-COMMUNITY">
    ...
    `
                    ...
                    const licenseInput = document.getElementById(
                        'cssscan-license-input'
                    );
                    window.onclick = function (event) {
                        const licenseBtn = document.getElementById(
                            'cssscan-check-license-btn'
                        );
                        if (event.target === licenseBtn) {
                ...
                chrome.runtime.onMessage.addListener(function (
                    ...
                    if (msg.text === 'are_you_there_content_script_modal?') {
                        if (
